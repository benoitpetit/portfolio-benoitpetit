let initialData = [
    ...
    },
    {
        ...
        entreprise:'MilkCreation',
        dates: 'nov. 2019 - déc. 2019',
        duration: '2 mois',
        location: 'Douai, Nord-Pas-de-Calais, France',
        details: 'Développeur PHP sur un framework maison basé sur Wordpress et Laravel, Developpement et Integration d\'un formulaire de souscription d\'abonnement.'
    }
]
